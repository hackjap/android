...
public class DBHelper extends SQLiteOpenHelper {
   ...
   public void onCreate(SQLiteDatabase db) {
      ...
      db.execSQL(memoSQL);
      db.execSQL("insert into expense(item,amount,created)values('새벳돈',50000,'2012-01-02')");



      db.execSQL("insert into expense(item,amount,created)values('알바',100000,'2021-02-25')");
