...
public class Main2Activity extends AppCompatActivity implements AutoPermissionsListener {
    ...
    private void locationService(){
        ...
        try{
            ...
            if(location != null){
                ...
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,minTime,minDistance,gpsListner);
            }
